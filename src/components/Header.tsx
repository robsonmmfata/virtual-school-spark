          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navItems.map((item) => (
              <ScrollLink
                ...
                className="cursor-pointer text-foreground hover:text-primary transition-colors duration-300 font-medium relative group"
              >
                {item.name}
            ...
            <nav className="flex flex-col py-4 space-y-2">
              {navItems.map((item) => (
                <ScrollLink
                  ...
                  duration={500}
                  offset={-80}
                  className="cursor-pointer px-4 py-2 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300"
